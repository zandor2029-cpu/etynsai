...
const CreditDisplay = ({ compact = false }: CreditDisplayProps) => {
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gradient-to-r from-watermelon-green/20 to-watermelon-pink/20 border border-watermelon-green/30">
        <Coins className="w-4 h-4 text-watermelon-green" />
        <span className="font-bold text-watermelon-green-light">{credits}</span>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <div className="p-2 rounded-lg bg-gradient-to-br from-watermelon-green/20 to-watermelon-pink/20">
            <Coins className="w-5 h-5 text-watermelon-green" />
          </div>
      ...
      <div className="space-y-2 text-xs text-muted-foreground">
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-1">
            <Zap className="w-3 h-3" /> Imagem 4K
          </span>
          <span>{CREDIT_COSTS.image} créditos</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="flex items-center gap-1">
            <TrendingUp className="w-3 h-3" /> Vídeo Motion
          </span>
