...
import { Heart, Mail, ExternalLink, Sparkles } from "lucide-react";
...
const Footer = () => {
  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: "Gerar Vídeos", href: "/kling-motion-control" },
  ...
  return (
    <footer className="relative mt-16 md:mt-24 border-t border-border/50">
      {/* Gradient background */}
      <div className="absolute inset-0 bg-gradient-to-t from-watermelon-green/5 via-transparent to-transparent pointer-events-none" />
      ...
      <div className="container mx-auto max-w-6xl px-4 py-12 md:py-16 relative">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <span>© {currentYear} Watermelon IA.</span>
          ...
          <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
            ...
            >
              <Heart className="w-4 h-4 text-watermelon-pink fill-watermelon-pink" />
            </motion.span>
            <span>e</span>
            <motion.span
          ...
          <a
            href="mailto:contato@watermelonia.com"
