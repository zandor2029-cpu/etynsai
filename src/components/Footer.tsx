  ...
  const columns = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Termos de Uso", to: "/termos-de-uso", icon: FileText },
      ],
    },
    {
      title: "Contato",
              ...
              <ul className="space-y-2.5">
                {col.links.map((link) => {
                  ...
                  if ("external" in link && link.external) {
                    return (
                      <li key={link.label}>
                        <a href={link.to} className="group inline-flex items-center gap-2 text-sm text-white/60 hover:text-white transition-colors">
                  ...
                  return (
                    <li key={link.label}>
                      <Link to={link.to} className="group inline-flex items-center gap-2 text-sm text-white/60 hover:text-white transition-colors">
                        <Icon className="w-3.5 h-3.5 opacity-60 group-hover:opacity-100 transition-all" />
                        {link.label}
                      </Link>
                    </li>
