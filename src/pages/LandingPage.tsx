      ...
      <div className="relative z-10 lg:pl-16 px-3 md:px-6 py-4 md:py-6">
            ...
            {productCards.map((card, i) => (
              ...
              >
                ...
                >
                  ...
                  {card.icon && (
                    <div className={`absolute ${card.large ? "top-5 left-5" : "top-3 left-3"} transition-transform duration-500 group-hover:scale-110`}>
                      <div className={`${card.large ? "w-14 h-14" : "w-10 h-10"} rounded-xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center`}>
                        <card.icon className={`${card.large ? "w-7 h-7" : "w-5 h-5"} text-white`} />
                      </div>
                    </div>
                  )}
                  ...
                  <div className={`absolute inset-x-0 bottom-0 ${card.large ? "p-5 md:p-7" : "p-3 md:p-4"} z-10`}>
                    ...
                    <h3 className={`${card.large ? "text-2xl md:text-4xl font-display font-extrabold uppercase tracking-tight leading-[0.95]" : "text-base md:text-lg font-display font-bold uppercase tracking-tight leading-tight"} text-white mb-1`}>
                      {card.title}
                    </h3>
                    <p className={`${card.large ? "text-sm md:text-base text-white/70 max-w-md" : "text-[11px] md:text-xs text-white/60"} leading-snug`}>
                      {card.subtitle}
                    </p>
        ...
        <section id="presets" className="container mx-auto max-w-7xl mb-12 md:mb-16">
          <div className="flex items-end justify-between mb-5 md:mb-6">
            ...
            <Link to="/image" className="hidden md:inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-white/70 hover:text-white transition-colors">
              Ver todos
              <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </div>
          ...
          <div className="relative">
            <button aria-label="Anterior" className="hidden md:flex absolute -left-4 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-black/80 backdrop-blur-md border border-white/20 items-center justify-center text-white/70 hover:text-white hover:border-white/50 transition-colors">
              <ChevronLeft className="w-4 h-4" />
            </button>
            <button aria-label="Próximo" className="hidden md:flex absolute -right-4 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full bg-black/80 backdrop-blur-md border border-white/20 items-center justify-center text-white/70 hover:text-white hover:border-white/50 transition-colors">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 md:gap-3">
              {presets.map((p, i) => (
                ...
                >
                  <div className={`absolute inset-0 bg-gradient-to-br ${presetGradients[i % presetGradients.length]}`} />
                  <div className="absolute inset-0 opacity-40 mix-blend-overlay" style={{ backgroundImage: "radial-gradient(circle at 50% 30%, rgba(255,255,255,0.2) 0%, transparent 60%)" }} />
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-2 md:p-3">
                    <div className="text-[9px] md:text-[10px] font-extrabold tracking-[0.1em] text-white uppercase">{p}</div>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <section id="tools" className="container mx-auto max-w-7xl mb-12 md:mb-16">
          <Link to="/image" className="group relative block overflow-hidden rounded-2xl border border-white/10 hover:border-white/30 transition-colors">
            <div className="aspect-[16/7] md:aspect-[16/5] relative">
              ...
              />
              <div className="absolute inset-0 opacity-30 mix-blend-overlay" style={{ backgroundImage: "radial-gradient(circle at 20% 30%, rgba(255,255,255,0.4) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(0,0,0,0.4) 0%, transparent 50%)" }} />
              <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/20 to-transparent" />
              <div className="absolute inset-0 flex flex-col justify-center p-6 md:p-12 lg:p-16 max-w-3xl">
                <div className="text-[10px] md:text-xs font-extrabold uppercase tracking-[0.2em] text-white/70 mb-3">Etyns Studio</div>
        ...
        <section id="showcase" className="container mx-auto max-w-7xl mb-12 md:mb-16">
          <div className="flex items-end justify-between mb-5 md:mb-6">
            ...
            <Link to="/meus-renders" className="hidden md:inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-white/70 hover:text-white transition-colors">
              Ver galeria
              <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3">
            {showcaseShots.map((s, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 opacity-40 mix-blend-overlay" style={{ backgroundImage: "radial-gradient(circle at 40% 40%, rgba(255,255,255,0.25) 0%, transparent 60%)" }} />
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent" />
                {s.tag === "VÍDEO" && (
                ...
                <div className="absolute inset-x-0 bottom-0 p-2 md:p-3">
                  <div className="text-[10px] md:text-[11px] font-extrabold tracking-[0.1em] text-white uppercase">{s.title}</div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <section id="pricing" className="container mx-auto max-w-7xl mb-12 md:mb-20">
          <div className="grid md:grid-cols-2 gap-3">
            <Link to="/planos" className="group relative overflow-hidden rounded-2xl border border-white/10 hover:border-white/30 transition-colors aspect-[16/9] md:aspect-[16/8]">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-600 via-orange-700 to-red-800" />
              <div className="absolute inset-0 opacity-30 mix-blend-overlay" style={{ backgroundImage: "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.4) 0%, transparent 60%)" }} />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
              <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-7">
                <div className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-white/70 mb-2">Planos</div>
            ...
            <Link to="/faq" className="group relative overflow-hidden rounded-2xl border border-white/10 hover:border-white/30 transition-colors aspect-[16/9] md:aspect-[16/8]">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 via-teal-700 to-cyan-800" />
              <div className="absolute inset-0 opacity-30 mix-blend-overlay" style={{ backgroundImage: "radial-gradient(circle at 70% 30%, rgba(255,255,255,0.4) 0%, transparent 60%)" }} />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
              <div className="absolute inset-0 flex flex-col justify-end p-5 md:p-7">
                <div className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-white/70 mb-2">Suporte</div>
                <h3 className="text-2xl md:text-3xl font-display font-extrabold uppercase text-white leading-tight tracking-tight mb-2">
